...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Add New Category</h3></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                 <?= form_open('category/addCategory',['class'=>'form-horaizontal']);?> <!-- doing form action -->
                                ...
                                <form class="form-valide">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <?=form_input(['name'=>'category_name','required'=>'required', 'class'=>'form-control','placeholder'=>"Category Name",'value'=>set_value('category_name')]);?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <?php
                                             ...
                                             ?>
                                            <?=form_dropdown('category_status',$data,1,['class'=>'form-control']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
