            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="inventory.php" aria-expanded="false"><i class="fa fa-tachometer"></i>Inventory</a></li>
                        <li> <a href="page-login.html" aria-expanded="false"><i class="fa fa-tachometer"></i>Logout</a></li>
